...
{{-- ════════════════════════════════════════════════════════════
     Skoracare — Split-Panel Confirm Password Page
     ════════════════════════════════════════════════════════════ --}}
<div class="sk-login-wrapper">
    ...
    <div class="sk-login-right">
        <div class="sk-login-card">
            ...
            <h1 class="sk-card-title">{{ __('Confirm Password') }}</h1>
            <p class="sk-card-subtitle">{{ __('Please confirm your password before continuing.') }}</p>
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="sk-form">
                @csrf
